...
use App\Http\Controllers\Admin\EditFormController;
...
class EditFormController extends Controller
{
    ...
    //    return redirect()->route('admin.auditrecords')->with('status',"Audit record added successfully");
    // }   
    ...
    //     $audit= Audit::findOrFail($id);
    //     return view('admin.auditview')->with('audit',$audit);
    // }
    ...
    //   // return redirect('/admin.auditrecords')->with('status','Audit record added successfully');
    //   //
    //   // return redirect()->back()->with('status',"Audit record updated successfully");
