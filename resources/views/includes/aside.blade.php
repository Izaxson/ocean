          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="users"></i><span>Head 
                  counts</span></a>
              <ul class="dropdown-menu">
               <li><a class="nav-link" href="{{route('admin.auditform')}}">Add New  </a></li>
                <li><a class="nav-link" href="{{route('admin.auditrecords')}}">view Records </a></li>
            ...
            <!-- <li class="dropdown">
              <a href="{{route('admin.users')}}" class="nav-link"><i data-feather="user"></i><span>User Management</span></a>
            </li> -->
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="trending-up"></i><span>Reports</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{route('admin.subcnty')}}">Reports per subcounty</a></li>
                <li><a class="nav-link" href="{{route('admin.department')}}">Reports per department</a></li>
                <li><a class="nav-link" href="{{route('admin.localethnicity')}}">Somali Ethnicity||Clans</a></li>
                <li><a class="nav-link" href="#">Ethnicity||Non-locals</a></li>
                <li><a class="nav-link" href="{{route('admin.gender')}}">Gender</a></li>
                <li><a class="nav-link" href="{{route('admin.qualification')}}">Academic Qualifications</a></li>
                <li><a class="nav-link" href="{{route('admin.disability')}}">Disability</a></li>
