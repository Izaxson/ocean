...
@section('content')
      <div>
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h1 class="mb-3 font-18 align="center" ><b> MALE {{$count = DB::table('audits')->count()}}<BR>FEMALE {{$count = DB::table('audits')->count()}}</b></h1>
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h1 class="mb-3 font-18 align="center" ><b> DISABLED {{$count = DB::table('audits')->count()}}<BR>NONE {{$count = DB::table('audits')->count()}}</b></h1>
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <h1 class="mb-3 font-18 align="center" ><b> LOCALS {{$count = DB::table('audits')->count()}}<BR>NON-LOCALS {{$count = DB::table('audits')->count()}}</b></h1>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <img  height="140" src="https://miro.medium.com/max/1252/0*Zw1ZfCk0svcXVQXg.jpg" width="240" height="119" alt="">
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <!-- <div>
               <img height="109" width="270" alt="image" src="{{ asset('assets/img/images.png')}}">
            </div> -->
