...
<form action="/admin/auditupdate/{{ $audit->id}}" method="POST">
                      @csrf
             ...
             <div class="row">
                  ...
                  <div class="card">
                    ...
                    <button class="btn btn-success " ><h4>STAFF AUDIT TOOL,OCTOBER 2020 AUDIT EDIT FORM</h4></button>
                        ...
                        <hr>
                            <div class="row clearfix">
                                ...
                                <label>Employee Name</label>
                                    ...
                                    <input style="text-transform: uppercase;" class="form-control" value="{{ $audit->employee_name}}"   value="{{ old('employee_name') }}" type="text" name="employee_name">
                                ...
                                <div class="col-md-4">
                                        <label>ID Number/Passport  No.</label>
                                         <input type="TEXT"  id="id_no"  value="{{ old('id_no') }}" value="{{ $audit->id_no}}" type="text" class="form-control" @error('id_no') is-invalid @enderror" name="id_no" value="{{ old('id_no') }}"  autocomplete="id_no" placeholder="Enter id no/passport no">
                                ...
                                <label>First Designation </label>
                                    <div class="form-group">
                                        ...
                                        <input style="text-transform: uppercase;" value="{{ $audit->employee_personal_no}}" placeholder="FIRST Designation " class="form-control"value="{{ old('first_designation') }}" type="text" name="first_designation">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                <label>Current Designation </label>
                                    ...
                                    <input style="text-transform: uppercase;" value="{{ $audit->current_designation}}" class="form-control"value="{{ old('current_designation') }}" type="text" name="current_designation" placeholder="Current Designation ">
                                ...
                                <label>Duty Station  </label>
                                    ...
                                    <input style="text-transform: uppercase;" value="{{ $audit->duty_station}}" placeholder="duty station " class="form-control" value="{{ old('duty_station') }}" type="text" name="duty_station">
                                    </div>
                                </div>

                                <div class="form-group col-md-2 ">
                                    <label>Sub County Duty station  </label>
                                    <select name="subcounty_duty_station"  value="{{  $audit->subcounty_duty_station}}) }}"  value="{{ old('subcounty_duty_station') }}"  class="form-control">
                                ...
                                <label>Section  </label>
                                    <div class="form-group">
                                    <select name="section" value="{{ $audit->section}}" value="{{ old('section') }}" class="form-control">
                                    <option value=""></option>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="home_county" value="{{ $audit->home_county}}" value="{{ old('home_county') }}"    class="form-control" id="HCounty">
                                    <option value=""></option>
                                ...
                                <label>Sub County  </label>
                                    <div class="form-group">
                                        ...
                                        <select name="sub_county" value="{{ $audit->sub_county}}"  value="{{ old('sub_county') }}"    class="form-control" Id="SubCounty">
                                    <option value=""></option>
                                ...
                                <label>Ethnicity  </label>
                                    <div class="form-group">
                                    <select name="ethnicity" value="{{ $audit->ethnicity}}"  value="{{ old('ethnicity') }}" class="form-control" id="Tribe">
                                    <option value=""></option>
                                ...
                                <div class="form-group col-md-4 d-none msomali">
                                    <label>Clan</label>
                                    <select name="clan"    value="{{ $audit->clan}}" value="{{ old('clan') }}" class="form-control" id="Clan">
                                    <option value=""></option>
                                ...
                                <div class="form-group col-md-4 d-none  msomali">
                                    ...
                                    <select name="sub_clan"     value="{{ $audit->sub_clan}}"  value="{{ old('sub_clan') }}" class="form-control" id="SubClan">
                                ...
                                <label>Mobile Number </label>
                                    ...
                                    <input type="tel"  value="{{ $audit->mobile_number}}" value="{{ old('mobile_number') }}" class="form-control"  name="mobile_number"   placeholder="Mobile Number">
                                ...
                                <label>Contact Address</label>
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="{{ $audit->contact_address}}" value="{{ old('contact_address') }}" name="contact_address" placeholder="Contact Address">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                <label>Email Address</label>
                                <div class="form-group">
                                        <input type="email" class="form-control" value="{{ $audit->email_address}}" value="{{ old('email_address') }}" name="email_address" placeholder="Email Address">
                                    </div>
                                </div>
                                <div class="col-md-4">
