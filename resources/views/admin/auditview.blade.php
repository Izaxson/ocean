...
<section class="section">
        <form action="/admin/auditview/{{ $audit->id}}" method="POST">
             ...
             <div class="row">
                <div class="col-6 col-md-12 col-lg-12">
                 ...
                 <img height="184" width="100%" alt="image" src="{{ asset('assets/img/mcpsblogo.png')}}"> 
                  ...
                  <button class="btn btn-success buttons-print" tabindex="0" aria-controls="tableExport"><span>Print</span></button>
                   </div>
                   @if (session('status'))
                   ...
                   <hr> <button class="btn btn-success ">AUDIT FORM</button><hr>
                          <div class="form-group" class="col-24 col-md-12 col-lg-12">
                              ...
                              <hr><button class="btn btn-danger " >MCPSB-AUD-ID-000{{ $audit->id }}</button> </hr>
                        ...
                        <hr>
                            <div class="row clearfix">
                                ...
                                <input type="text" disabled value="{{ $audit->mobile_number}}" class="form-control"  > 
                                </div>
